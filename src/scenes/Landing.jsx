      ...
      <div className="md:order-2 flex justify-center basis-3/5 z-10 mt-16 md:mt-10">
        {isAboveMediumScreens ? (
          <div
            ...
            before:rounded-t-[400px] before:w-full max-w-[400px] before:h-full before:border-2 before:border-blue before:z-[-1] "
          >
            <img
              alt="Profile picture"
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          <p className="text-6xl font-playFair z-10 text-center md:text-start">
            Billy{" "}
            <span className="xs:relative xs:font-semibold z-20">Langdown</span>
          </p>
        ...
        >
          <AnchorLink
            className="bg-gradient-to-r from-sky-400 via-pink-500 to-yellow-400 text-deep-blue rounded-sm py-3 px-7 font-semibold hover:bg-blue hover:text-white transition duration-500"
            onClick={() => {
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
          transition={{ delay: 0.2, amount: 0.2 }}
          variants={{
            hidden: { opacity: 0, x: -50 },
            visible: { opacity: 10, x: 0 },
          }}
        >
          <AnchorLink
            className="rounded-r-sm bg-gradient-to-r from-sky-400 via-pink-500 to-yellow-400 py-0.5 pr-0.5"
            onClick={() => {
              setSelectedPage("contact");
            }}
            href="#contact"
