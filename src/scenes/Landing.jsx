      ...
      <div className="md:order-2 flex justify-center basis-3/5 z-10 mt-16 md:mt-10">
        {isAboveMediumScreens ? (
          <div
            ...
            before:rounded-[200px] before:w-[350px] max-w-[400px] before:h-[350px]  before:bg-brightOrange before:z-[-1] "
          >
            <div
            className="relative z-0 before:absolute before:-bottom-32 before:-right-40
            before:rounded-[300px] before:w-[400px] max-w-[400px] before:h-[400px]  before:bg-lightBrown before:z-[-1] "
          >
                        <div
            className="relative z-0 before:absolute before:-bottom-40 before:-left-32
             before:w-[250px] before:rounded-br-[200px] before:rounded-tl-[200px]  max-w-[300px] before:h-[400px]  before:bg-brown before:z-[-1] "
          >
                                    <div
            className="relative  z-0 before:absolute before:-top-48 before:-right-32
             before:w-[300px] before:rounded-tl-[200px] before:rounded-br-[200px] max-w-[300px] before:h-[400px]  before:bg-darkBrown before:z-[-1] "
          >
            <img
              alt="Profile picture"
